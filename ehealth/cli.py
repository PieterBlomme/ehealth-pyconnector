...
def download_packages():
    ...
    DOWNLOAD_URL = "https://repo.ehealth.fgov.be/artifactory/maven2/be/fgov/ehealth/connector/connector-packaging-persphysiotherapist/4.5.4/connector-packaging-persphysiotherapist-4.3.0-java.zip"
